...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { base: @drink.base, description: @drink.description, name: @drink.name, shop: @drink.shop, waves: @drink.waves } }, as: :json
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { base: @drink.base, description: @drink.description, name: @drink.name, shop: @drink.shop, waves: @drink.waves } }, as: :json
    assert_response 200
  end
